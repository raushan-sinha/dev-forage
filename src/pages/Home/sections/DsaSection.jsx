...
export default function DsaSection() {
    ...
    return (
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[#0D111E]">
                ...
                <div className="bg-gradient-to-r from-green-100 to-blue-100 rounded-2xl p-8 md:p-12">
                    <div className="flex flex-wrap gap-4 justify-center mb-8">
                        {dsaSection.topics.map((topic, index) => (
                            <span
                                key={index}
                                className="bg-white px-4 py-2 rounded-full text-sm md:text-base font-semibold text-gray-700 shadow-sm font-mono"
                            >
                                {topic}
                            </span>
                        ))}
