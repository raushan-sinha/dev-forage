    ...
    return (
        <div className="min-h-screen bg-[#0f172a] text-white px-6 pt-24 pb-16">
            <div className="max-w-7xl mx-auto">
                ...
                <header className='flex flex-col items-center gap-3 md:gap-20 md:flex-row'>
                    ...
                    <div className="w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl mx-auto relative" id="input">
                        <input
                            ...
                            type="text"
                            className="w-full text-sm h-[50px] px-4 text-white font-mono bg-transparent rounded-[8px] border border-slate-200 focus:border-primary focus:outline-primary focus:ring-0 hover:border-brand-500-secondary overflow-ellipsis overflow-hidden text-nowrap pr-[48px]"
                        />
                        <div className="absolute top-3 right-3">
                            <svg fill="cyan" viewBox="0 0 24 24" height={24} width={24} className='cursor-pointer hover:opacity-80 transition'>
