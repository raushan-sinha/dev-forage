        ...
        <>
            <div className="min-h-screen flex flex-col items-center justify-center gap-8 bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] px-4 sm:px-6 md:px-10 py-12 sm:py-16 lg:py-20">
                ...
                <div className="col-span-6 flex justify-center gap-3">
                    {icons.map((item, idx) => (
                        <button className="fill-slate-600 flex justify-center items-center rounded-lg p-3 duration-300 bg-slate-50/80 hover:bg-slate-100 hover:border-slate-600 active:scale-95 focus:fill-blue-200 focus:bg-blue-400 border border-slate-200 hover:shadow-md group" key={idx} onClick={() => addEmoji(item.emoji)}>
                            {item.icon}
                        </button>
                    ))}
